...
Parquet is a format "row block embedded columns separated by pages" built to handle flat columnar storage data formats. It is designed for efficient data storage and retrieval. 
