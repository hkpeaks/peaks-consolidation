...
The Peaks framework may be open-sourced if there is a sufficient demand for it. The number of stars obtained by this repository is a good indication of your demand for this framework. If this project is proven successfully, I can consider to provide an alternative imeplementation using Rust programming language.
