...
detail_filename = f"Outbox/DuckDB_TupleForm_Detail_Result_{sys.argv[1].replace('.parquet', '')}.parquet"
summary_filename = f"Outbox/DuckDB_TupleForm_Summary_Result_{sys.argv[1].replace('.parquet', '')}.parquet"
