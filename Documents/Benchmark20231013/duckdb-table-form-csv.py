...
detail_filename = f"Outbox/DuckDB_TableForm_Detail_Result_{sys.argv[1].replace('.csv', '')}.csv"
summary_filename = f"Outbox/DuckDB_TableForm_Summary_Result_{sys.argv[1].replace('.csv', '')}.csv"
